public class TileActivity {
    ...
    static Activity start = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.START));
        return;
    };

    static Activity jail = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.JAIL));
        return;
    };
    
    static Activity freeParking = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.FREE_PARKING));
        return;
    };
    
    static Activity goToJail = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.GO_TO_JAIL));
        return;
    };
        
    static Activity chance = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.CHANCE));
        return;
    };
    
    static Activity burgerShop = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.BURGER_SHOP));
    ...
    static Activity pizzeria = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.PIZZERIA));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-1)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity candyShop = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.CANDY_SHOP));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-1)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity iceCreamShop = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.ICE_CREAM_SHOP));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-1)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity museum = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.MUSEUM));
        if (owners[tile.ordinal()] == null) {
    ...
    static Activity library = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.LIBRARY));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-2)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity skatePark = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.SKATE_PARK));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-2)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity swimmingPool = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.SWIMMING_POOL));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-2)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity cinema = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.ARCADE));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-3)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity toyShop = tile -> {
        if (owners[tile.ordinal()] == null) {
        System.out.println(Languages.getLanguage(LanguageIndex.TOY_SHOP));
            if (PlayerController.getCurrentPlayer().addCash(-3)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity petShop = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.LANDED) + Languages.getLanguage(LanguageIndex.PET_SHOP));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-3)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity bowlingAlley = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.BOWLING_ALLEY));
        if (owners[tile.ordinal()] == null) {
    ...
    static Activity zoo = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.ZOO));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-4)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
    ...
    static Activity waterPark = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.WATER_PARK));
        if (owners[tile.ordinal()] == null) {
    ...
    static Activity beachPromenade = tile -> {
        System.out.println(Languages.getLanguage(LanguageIndex.BEACH_PROMENADE));
        if (owners[tile.ordinal()] == null) {
            if (PlayerController.getCurrentPlayer().addCash(-5)) {
                owners[tile.ordinal()] = PlayerController.getCurrentPlayer();
